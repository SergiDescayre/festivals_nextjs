      ...
      <div className=" bg-dark75">
        ...
        <div className="px-3 flex flex-col gap-2 py-4 text-secondary">
          <div className="flex gap-2">
            <Image  src="/assets/location.svg"  width={12} height={12}  alt="location" />
            <span className="text-xs ">{fest.address}</span>
          </div>

          <div className="flex gap-2 text-xs">
            <Image  src="/assets/calendar.svg" width={12} height={12} alt="calendar" />
            <DateFestival date={fest.data_start} /> 
          </div>

          <div className="flex gap-2">
            <Image src="/assets/price.svg"  width={12} height={12} alt="price" />
